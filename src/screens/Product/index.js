...
import { BaseColor, BaseStyle, ExtraSafeMode, useTheme } from "src/config";
// Load sample data
import { EPostListData, ESortOption } from "src/data";
...
// import { PRODUCT_LIST_API } from "src/api";
...
const PostTab = () => {
    ...
    return (
        <SafeAreaView
            style={[BaseStyle.safeAreaView, ExtraSafeMode(colors.background)]}
